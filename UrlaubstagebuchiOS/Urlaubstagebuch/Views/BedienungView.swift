...
struct BedienungView: View {
    ...
    private let woSteht: [Griff] = [
        ...
        Griff(zeichen: "paragraphsign",
              ...
              wie: "Block → Schrift an dieser Stelle → Absatzabstand, oder buchweit unter Buch → Schrift. Steht darunter eine hohe Absatzzahl, ist jede Zeile ein eigener Absatz — dann hilft „Absätze zusammenführen“."),
        ...
        Griff(zeichen: "ruler.fill",
              ...
              wie: "Anordnen → „An Rand und Nachbarn einrasten“. Beim Schieben zeigt eine Linie, woran gerade gefangen wird — Rand, Schnittkante oder Nachbar. Auf den Millimeter genau geht es über Block → Lage auf der Seite."),
