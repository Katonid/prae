...
struct BedienungView: View {
    ...
    private let woSteht: [Griff] = [
        ...
        Griff(zeichen: "drop.circle",
              ...
              wie: "Nichts auswählen \u{2192} Pinsel \u{2192} Wasserzeichen. Dort stehen der Winkel, den die Automatik dieser Seite gibt, und eine Skizze, wo das Zeichen liegt; darüber lässt sich beides von Hand korrigieren. Was nicht angefasst ist, folgt weiter der Automatik."),
