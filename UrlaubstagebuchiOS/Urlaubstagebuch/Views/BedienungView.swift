...
struct BedienungView: View {
    ...
    private let aufSeite: [Griff] = [
        ...
        Griff(zeichen: "book.pages",
              ...
              wie: "Der Umschalter unten links stellt zwischen Einzelseiten und aufgeschlagenem Buch um. Seite 1 ist immer eine rechte Seite. Der erste Bogen ist der UMSCHLAG: links die Rückseite des Buches, in der Mitte der Rücken, rechts die Titelseite. Wer das nicht will, schaltet es unter \u{201E}Ganzes Buch\u{201C} \u{2192} Titel, Umschlag und Rücken ab; dann liegt links wieder die Innenseite des Umschlags, die von der Druckerei kommt und in keinem PDF steht."),
    ...
    private let woSteht: [Griff] = [
        ...
        Griff(zeichen: "book.closed.fill",
              ...
              wie: "\u{201E}Ganzes Buch\u{201C} (Buchsymbol oben rechts) \u{2192} Titel, Umschlag und Rücken. Dort steht, was auf den Rücken gedruckt wird (leer heißt: der Buchtitel), was auf der Rückseite steht, und wie dick das Buch wird. Und dort bekommt der Umschlag seine EIGENE Gestaltung \u{2014} Hintergrund, Schrift, Titelgröße, Rand. Was dort nicht gesetzt ist, folgt weiter dem Buch."),
        ...
        Griff(zeichen: "rectangle.dashed",
              ...
              wie: "\u{201E}\u{2026}\u{201C} oben rechts \u{2192} \u{201E}Linien zeigen\u{201C}. ROT mit langen Strichen ist die Schnittkante \u{2014} dort wird beschnitten, alles au\u{00DF}erhalb ist Anschnitt. BLAU mit kurzen ist der Sicherheitsabstand; dort soll nichts stehen, was gelesen werden muss. GRAU und fein gepunktet ist der Satzspiegel. Solange die Linien an sind, steht die Legende dazu \u{00FC}ber der B\u{00FC}hne.\n\nWas in den Sicherheitsabstand ragt, wird blau umrandet, und unter dem Blatt steht, wie viele Bl\u{00F6}cke es sind. In der Doppelseitenansicht fehlt die rote Linie am BUND \u{2014} dort wird gefalzt und nicht geschnitten."),
        Griff(zeichen: "book.pages",
