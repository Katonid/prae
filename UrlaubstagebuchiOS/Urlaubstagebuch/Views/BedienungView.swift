...
struct BedienungView: View {
    ...
    private let woSteht: [Griff] = [
        ...
        Griff(zeichen: "book.closed",
              ...
              wie: "Buchsymbol \u{2192} Umschlag \u{2192} Abschnitt „Tabelle des Druckdienstes“. Je Zeile: ab wie vielen Seiten sie gilt und wie viele Millimeter. Steht dort etwas, gilt es statt der Rechnung aus Papierstärke und Einband \u{2014} und die Gesamtbreite des Bogens folgt von selbst."),
        Griff(zeichen: "drop",
