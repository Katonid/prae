...
struct BedienungView: View {
    ...
    private let woSteht: [Griff] = [
        ...
        Griff(zeichen: "mappin.and.ellipse",
              ...
              wie: "Das Tagesmenü unten rechts \u{2192} Reisepunkte \u{2192} „Punkte auf der Karte“. Dort ist jeder Punkt ANTIPPBAR: Der getroffene wird hervorgehoben, die Karte schiebt man unter das Fadenkreuz und tippt „Übernehmen“ \u{2014} oder „Löschen“. Über die Liste geht es auch; auf der Karte findet man einen bestimmten Punkt leichter wieder."),
        ...
        Griff(zeichen: "text.alignleft",
              ...
              wie: "Der Pinsel \u{2192} Ränder, Karte, Seitenzahlen \u{2192} Abschnitt „Textspalte“. Von Haus aus höchstens zwei Drittel der Satzbreite; wie viele Zeichen dabei auf einer Zeile stehen, misst die Prüfung vor dem Ausgeben."),
        Griff(zeichen: "point.topleft.down.curvedto.point.bottomright.up",
              was: "Wie die Reisepunkte auf der Buchkarte aussehen",
              wie: "Der Pinsel \u{2192} Ränder, Karte, Seitenzahlen \u{2192} „Reisepunkte“. Wahlweise gar keine (nur die Linie), dezent in der Linienfarbe, nur Anfang und Ziel, oder mit hellem Ring."),
