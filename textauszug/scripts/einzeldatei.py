#!/usr/bin/env python3
"""Baut den Textauszug zu EINER HTML-Datei zusammen, die per Doppelklick läuft.
...
weiter. Ein blosses Aneinanderhängen ginge nicht: `suche` und `teil` kämen mehrfach vor, und
zweimal derselbe `const`-Name im selben Bereich ist ein Syntaxfehler.
