...
- **Kanada-Steuer:** Ontario (13 %) und Quebec (14,975 %) per Knopf oder
  automatisch über den Standort
- **US Sales Tax:** Stadtfeld mit sofortiger Erkennung der voreingestellten
  Städte (Buffalo 8,75 %, Niagara Falls 8 %, Detroit 6 %), Erkennung aller
  US-Bundesstaaten-Basissätze aus der Eingabe, Online-Ortssuche (Apple
  Geocoder statt Nominatim) sowie manuelles Tax-%-Feld (0–15 %)
- **Standort-Knopf:** bestimmt in Kanada die Provinz, in den USA Stadt bzw.
  Bundesstaat für die Sales Tax; außerhalb von Kanada/USA gibt es einen
  ehrlichen Hinweis
...
Farben, Flaggen (inkl. Ahornblatt-Polygon), Verläufe, Karten- und
Feld-Layout sind 1:1 aus dem Stylesheet der PWA übernommen; die Flaggen
werden wie im Original ohne Bilddateien direkt gezeichnet.
