# Klänge — Herkunft und Lizenzen

Übernommen aus der Tafelbild-App (`TafelbildiOS/Tafelbild/Klaenge/`),
dort erzeugt von `TafelbildiOS/scripts/fetch-geburtstag.py`.
...
| Fanfare | `geburtstag-tusch2.wav` | United States Navy Band | gemeinfrei (Werk der US-Regierung) | https://commons.wikimedia.org/wiki/File:Jubilant_Fanfare.mp3 |
...
| Geburtstagslied | `geburtstag-lied.wav` | gerechnet (Glockenspiel) | Melodie gemeinfrei (Mildred Hill, † 1916) | — |
