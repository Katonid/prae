...
const paths = {
  ...
  frameOn: '<rect x="3.5" y="5" width="17" height="14" rx="3"/><path d="M7.5 12h9"/>',
  frameOff: '<path d="M6.5 5h11a3 3 0 0 1 3 3v8"/><path d="M17.5 19h-11a3 3 0 0 1-3-3V8"/><path d="M4 4l16 16"/>',
  palette: '<path d="M12 3a9 9 0 1 0 0 18c1.2 0 1.8-.9 1.8-1.8 0-1.4-1-1.7-1-2.7 0-.8.7-1.5 1.6-1.5H16a5 5 0 0 0 5-5c0-3.9-4-7-9-7z"/><circle cx="7.5" cy="11" r="1.1"/><circle cx="10" cy="7.5" r="1.1"/><circle cx="14.5" cy="7.5" r="1.1"/>',
  ...
  eyeOff: '<path d="M2 12s3.6-6.5 10-6.5S22 12 22 12s-3.6 6.5-10 6.5S2 12 2 12z"/><circle cx="12" cy="12" r="3"/><path d="M4 4l16 16"/>',
