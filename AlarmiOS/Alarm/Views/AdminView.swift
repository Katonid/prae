        ...
        List {
            ...
            .onDelete { indexSet in
                ...
                Text("„Kürzel ändern“ berichtigt einen Tippfehler oder ein "
                     ...
                     + "dem betroffenen Gerät kommt das neue Kürzel beim "
                     + "nächsten Öffnen der App an.\n\n"
                     + "Ein Mitglied ist eine APPLE-ID, kein Gerät. Wer beitritt, "
                     + "wird Mitglied; Admin wird man nur, indem ein Admin "
                     + "einen dazu ernennt — es dürfen beliebig viele sein.\n\n"
                     + "Zwei Geräte mit derselben Apple-ID sind EIN Mitglied mit "
                     ...
                     + "eine Gerät — das Kollegium merkt nichts davon. Auf dem "
                     ...
                     + "geschrieben hat. Die Zustellung beweist ein zweites Gerät "
                     + "oder gar nichts.\n\n"
                     + "Mindestens zwei Personen sollten Admin sein. Sonst "
                     + "kann niemand mehr Codes vergeben, Standorte pflegen oder "
                     + "Entwarnung geben, sobald dieses eine Gerät zurückgesetzt "
                     + "wird.")
            }
        }
