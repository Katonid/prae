...
// CloudKit-Synchronisation — gleiches Muster wie in Canada2026:
//
...
//   kind        (String)  – Entitätstyp ("trip" oder "expense")
...
//   asset       (CKAsset) – nur bei Einträgen mit Foto: die JPEG-Datei
//
...
// nachgeschoben, sobald wieder Netz da ist. Jedes Gerät braucht nur
// irgendein iCloud-Konto — Mitreisende brauchen keine gemeinsame Apple-ID.
...
final class CloudSyncEngine {
    ...
    private let queue = DispatchQueue(label: "reisekasse.cloudsync")
    ...
    func ensureSubscription() {
        ...
        let subscription = CKQuerySubscription(
            ...
            subscriptionID: "reisekasse-entity-changes",
