#!/usr/bin/env python3
"""Erzeugt das App-Icon von Klassenraum — in mehreren Farben.
...
(`setAlternateIconName`). Ein freier Farbwähler ist damit ausgeschlossen.
    ...
    python3 KlassenraumiOS/scripts/generate-icon.py

Erzeugt wird:
  * `Assets.xcassets/AppIcon.appiconset/AppIcon1024.png` — die Vorgabe, also
    auch das Bild im App Store.
  * `Klassenraum/Symbole/Icon<Farbe>@2x.png`, `@3x.png`, `@2x~ipad.png` — die
...
def main():
    ...
    katalog = os.path.join(wurzel, "Klassenraum", "Assets.xcassets",
                           "AppIcon.appiconset", "AppIcon1024.png")
    lose = os.path.join(wurzel, "Klassenraum", "Symbole")
