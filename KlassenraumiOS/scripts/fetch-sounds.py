...
`KlassenraumiOS/Klassenraum/Klaenge/Klaenge-Lizenz.md`.
...
Aufbereitung, für jede Datei gleich:
  ...
  * winzige Ein- und Ausblendung, damit es an den Schnittkanten nicht knackt.
    ...
    python3 KlassenraumiOS/scripts/fetch-sounds.py

Ergebnis: `KlassenraumiOS/Klassenraum/Klaenge/*.wav`. Nicht von Hand bearbeiten.
"""
...
KENNUNG = {"User-Agent": "KlassenraumAssetTool/1.0 "
...
def main():
    ...
    ordner = os.path.join(wurzel, "Klassenraum", "Klaenge")
    ...
    with open(os.path.join(ordner, "Klaenge-Lizenz.md"), "w", encoding="utf-8") as datei:
        datei.write(
            ...
            "**Nicht von Hand bearbeiten** — `KlassenraumiOS/scripts/fetch-sounds.py`\n"
