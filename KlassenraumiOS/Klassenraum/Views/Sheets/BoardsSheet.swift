    ...
    private func besitzAbschnitt(_ board: Board) -> some View {
        Section {
            ...
            Text("Du verschickst einen Link — über Nachrichten, Mail oder was "
                 ...
                 + "und darf auch gleich mitschreiben; eine Rückfrage nach "
                 + "Rechten gibt es bewusst nicht. Nur-Zuschauen hätte hier "
                 + "wenig Sinn: Von einer Auslosung, die man nicht auslösen "
                 + "kann, hat niemand etwas.\n\n"
