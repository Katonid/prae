# Klassenraum im App Store — was einzutragen ist
...
| Punkt | Wo |
|---|---|
| App-Symbol (1024 px, ohne Alphakanal) | `Klassenraum/Assets.xcassets/AppIcon.appiconset` |
| Alternative Symbolfarben | `Klassenraum/Symbole/` |
...
```
Klassenraum macht aus dem iPad eine Tafel für den Unterricht: Zufallsname,
