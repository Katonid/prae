...
`geburtstag-*.wav` — zwei echte Aufnahmen und ein gerechnetes Lied.
(Eine Luftrüssel-Aufnahme war dabei und ist wieder raus: Sie klang
gequält, und ein schlechter Klang ist schlechter als keiner.)
